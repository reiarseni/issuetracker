    ...
    public function newCommentAction(Request $request, Requirement $requirement)
    {
        ...
        $form = $this->createForm( CommentType::class, $comment, array(
            ...
            'action' => $this->generateUrl('requirement_comment_new',
                array('requirement' => $requirement->getId())
            ),
        ));
        ...
        return $this->render('requirement/comment/new.html.twig', array(
            'requirement' => $requirement,
            'comment' => $comment,
            'form' => $form->createView()
        ));
    ...
    public function editCommentAction(Request $request, Requirement $requirement, Comment $comment)
    {
        ...
        $editForm = $this->createForm( CommentType::class, $comment, array(
            ...
            'action' => $this->generateUrl('requirement_comment_edit',
                array('requirement' => $requirement->getId(), 'id'=>$comment->getId())
            ),
        ));
        ...
        return $this->render('requirement/comment/edit.html.twig', array(
            'requirement' => $requirement,
