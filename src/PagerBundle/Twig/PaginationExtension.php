...
class PaginationExtension extends \Twig_Extension
{
    ...
    {
        return $twig->render('@Pager/filters/select.html.twig', compact('key', 'pagination', 'options'));
    }

    public function filterDropdown(\Twig_Environment $twig, Pagination $pagination, $key, array $options)
    {
        $default = reset($options);
        return $twig->render('@Pager/filters/dropdown.html.twig', compact('key', 'pagination', 'options', 'default'));
    }
    ...
    public function filterSearch(\Twig_Environment $twig, Pagination $pagination, $key, $placeholder = '')
    {
        ...
        return $twig->render('@Pager/filters/search.html.twig', compact('key', 'pagination', 'value', 'placeholder'));
    }
    ...
    {
        return $twig->render('@Pager/pagination.html.twig', compact('pagination'));
    }
